...
<html>
    ...
    <body class="sub_page">
        ...
        <!-- main -->
        <a href="productlist?cp=1"><p style="margin-left: 20px; margin-top: 10px; font-size: 18px"><--Back</p></a>
            ...
            <div class="row m-0">
                ...
                <div class="col-lg-6">
                    <div class="right-side-pro-detail border p-3 m-0">
                        <form action="${pageContext.request.contextPath}/update" method="post" id="myForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12" style="margin-top: 10px">
                                    ...
                                    <select name="cateID">
                                        <c:forEach items="${listCate}" var="o">
                                            <option value="${o.id}" <c:if test="${o.id == update.categoryID}">selected</c:if>>
                                                ${o.name}
                                            </option>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="col-lg-12" style="margin-top: 10px">
                                    <label>Status</label>
                                    <select name="status">
                                        <option value="0" <c:if test="${update.status == 0}">selected</c:if>>Presently</option>
                                        <option value="1" <c:if test="${update.status == 1}">selected</c:if>>Hidden</option>
                                        </select>
