...
<body>
    ...
    <div class="container bootstrap snippet">
        <div class="row">
            ...
            <div class="col-sm-2"><a href="home" class="pull-right"><img title="Back to shop" class="img-circle img-responsive" src="images/BookShop-logo.png" alt="BackToShop"></a></div>
        </div>
        <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        ...
                        <form class="form" action="changeProfile" method="post" id="registrationForm">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="productlist"><h4>Book</h4></label>
                                    <input type="text" class="form-control" name="productlist" id="productlist" value="${sessionScope.account.productlistNumber}"
                                           required   placeholder="enter productlist">
                                </div>
                            </div>
